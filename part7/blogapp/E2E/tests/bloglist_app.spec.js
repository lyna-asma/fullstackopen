...
describe('Blog app', () => {
  ...
  describe('when logged in', () => {
    ...
    test('a new blog can be created', async ({ page }) => {
      ...
      await expect(
        page.getByText('Component testing is done with react-testing-library').first()
      ).toBeVisible();
    });
    ...
    test('user who added the blog can delete it', async ({ page }) => {
      ...
      await page
        .getByRole('link', { name: 'Component testing is done with react-testing-library' })
        .click();
      ...
      await expect(
        page.getByRole('link', { name: 'Component testing is done with react-testing-library' })
      ).not.toBeVisible();
    });
