...
describe("Blog app", () => {
  ...
  test("Login form is shown", async ({ page }) => {
    // The login form isn't shown on page load anymore — login is now its
    // own route (/login), so we have to click the nav "login" link first
    // to get there before checking the form is visible.
